...
<li><a href="{{url('employees/employee-team')}}">Teams</a></li>
<li><a href="{{url('employees/employee-office')}}">Projects</a></li>
<li><a href="{{url('employees/employee')}}">View All Employee</a></li>
</ul>
<a class="btn-add" href="{{url('employees/add-employee')}}"><i data-feather="plus"></i> Add Person</a>
</div>
</div>
