...
<ul class="breadcrumb">
<li class="breadcrumb-item"><img src="{{url('assets/img/dash.png')}}" class="mr-3" alt="breadcrumb" />Home
</li>
...
$employees = App\Models\Employeedata::where('emp_id','=','$emp_id')->first();
@endphp       
...
@if($empleave->count() == 0 && $wfhleave->count() == 0 && $companyinfos->count() == 0)
@else
<button type="button" class="btn btn-success">+{{$empleave->count()+$wfhleave->count()+$companyinfos->count()}}&nbsp;New</button></h4>
@endif 
</div>
   ...
   <div class="col-xs-12 col-sm-12">
      <div class="new-message-box">
                    <div class="new-message-box-success">
                        ...
                        <p>Congrats!!!&nbsp;{{$notification->name}} Your Request For Leave Has been Approved  &nbsp;
                            <a class="btn btn-sm" href="/empmarkasreadA/{{$notification->id}}"> <button type="button" class="btn btn-info">Mark As Seen</button></a>
                        </p>   </div>
                    </div>
                </div>
</div>
   ...
   <div class="new-message-box">
                    <div class="new-message-box-danger">
                        ...
                        <div class="tip-box-danger">
                            ...
                            <p>Sorry!!!&nbsp;{{$notification->name}} Your Request For Leave Has been Rejected &nbsp;
                           <a class="btn btn-sm" href="/empmarkasreadR/{{$notification->id}}"> <button type="button" class="btn btn-info">Mark As Seen</button></a>
                            </p> </div>
                    </div>
                </div>
   </div>
   ...
   <div class="col-xs-12 col-sm-12">
      <div class="new-message-box">
                    <div class="new-message-box-success">
                        <div class="info-tab tip-icon-success" title="success"><i></i></div>
                        <div class="tip-box-success">
                        <p>Congrats!!!&nbsp;{{$notification->wname}} Your Request For WFH Has been Approved  &nbsp;
                            <a class="btn btn-sm" href="/wempmarkasreadA/{{$notification->id}}"> <button type="button" class="btn btn-info">Mark As Seen</button></a>
                        </p>   </div>
                    </div>
                </div>
</div>
...
@elseif($notification->status == 'Rejected')
   ...
   <div class="new-message-box">
                    <div class="new-message-box-danger">
                        ...
                        <div class="tip-box-danger">
                            <!--<p><strong>Tip:</strong> If you want to enable the fading transition effect while closing the alert boxes, apply the classes <code>.fade</code> and <code>.in</code> to them along with the contextual class.</p>-->
                            <p>Sorry!!!&nbsp;{{$notification->wname}} Your Request For WFH Has been Rejected &nbsp;
                           <a class="btn btn-sm" href="/wempmarkasreadR/{{$notification->id}}"> <button type="button" class="btn btn-info">Mark As Seen</button></a>
                            </p> </div>
                    </div>
                </div>
   </div>
...
@foreach($companyinfos as $notification)
<div class="col-xs-12 col-sm-12 ">
   <div class="new-message-box">
                    <div class="new-message-box-info">
                        ...
                        <div class="tip-box-info">
                            <!--<p><strong>Tip:</strong> If you want to enable the fading transition effect while closing the alert boxes, apply the classes <code>.fade</code> and <code>.in</code> to them along with the contextual class.</p>-->
                            <p>Attention!!!&nbsp;{{$notification->name}} Updated!!! &nbsp;
                           <a class="btn btn-sm" href="/empmarkasreadP/{{$notification->id}}"> <button type="button" class="btn btn-info">Mark As Seen</button></a>
                            </p> </div>
                    </div>
                </div>
   </div>
