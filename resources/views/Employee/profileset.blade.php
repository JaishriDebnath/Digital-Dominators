...
<a href="/Employee/EmployeeDashboard"><img src="{{url('assets/images/return.png')}}" style="width: 50px;height:50px"></a>
<center>
...
@else
<img src="/profile/employee/{{$profiles->eimage}}" id="photo">
@endif

<form action="/Employee/profilePic" method="POST" enctype="multipart/form-data">
    @csrf

  <input type="file" id="file" name="eimage"> 
